...
export const Search: React.FC<React.SVGProps<SVGSVGElement>> = ({ width = 11, height = 11, ...props }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} fill="none" viewBox="0 0 11 11" {...props}>
      <path
        fill="#666"
