...
export const MoreValues: React.FC<React.SVGProps<SVGSVGElement>> = ({ fill = '#30C1FF', ...props }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="9" height="8" fill="none" viewBox="0 0 9 8" {...props}>
      <path
        fill={fill}
