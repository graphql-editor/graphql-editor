      ...
      Graf: {
        ...
        ActiveNode: {
          ...
          ActiveField: {
            ...
            editableName:
              'tree-elements-Graf-ActiveNode-ActiveField-editableName',
            type: 'tree-elements-Graf-ActiveNode-ActiveField-type',
            editableDefaultValue:
              'tree-elements-Graf-ActiveNode-ActiveField-editableDefaultValue',
            editableArgumentName:
              'tree-elements-Graf-ActiveNode-ActiveField-editableArgumentName',
            Menus: {
              ExpandInput:
                'tree-elements-Graf-ActiveNode-ActiveField-Menus-ExpandInput',
              ExpandOutput:
                'tree-elements-Graf-ActiveNode-ActiveField-Menus-ExpandOutput',
              ChangeType: {
                button:
                  'tree-elements-Graf-ActiveNode-ActiveField-Menus-ChangeType-button',
                menu: {
                  title:
                    'tree-elements-Graf-ActiveNode-ActiveField-Menus-ChangeType-menu-title',
                  searchInput:
                    'tree-elements-Graf-ActiveNode-ActiveField-Menus-ChangeType-menu-searchInput',
                  optionToSelect:
                    'tree-elements-Graf-ActiveNode-ActiveField-Menus-ChangeType-menu-optionToSelect',
                },
              },
              Options: {
                button:
                  'tree-elements-Graf-ActiveNode-ActiveField-Menus-Options-button',
                menu: {
                  delete:
                    'tree-elements-Graf-ActiveNode-ActiveField-Menus-Options-menu-delete',
                },
              },
              Required: {
                button:
                  'tree-elements-Graf-ActiveNode-ActiveField-Menus-Required-button',
                menu: {
                  required:
                    'tree-elements-Graf-ActiveNode-ActiveField-Menus-Required-menu-required',
                  array:
                    'tree-elements-Graf-ActiveNode-ActiveField-Menus-Required-menu-array',
                  arrayRequired:
                    'tree-elements-Graf-ActiveNode-ActiveField-Menus-Required-menu-arrayRequired',
                },
              },
            },
          },
          TopNodeMenu: {
            searchableMenu: {
              title:
                'tree-elements-Graf-ActiveNode-TopNodeMenu-searchableMenu-title',
              searchInput:
                'tree-elements-Graf-ActiveNode-TopNodeMenu-searchableMenu-searchInput',
              optionToSelect:
                'tree-elements-Graf-ActiveNode-TopNodeMenu-searchableMenu-optionToSelect',
            },
            CreateField:
              'tree-elements-Graf-ActiveNode-TopNodeMenu-CreateField',
            ...
            Required: 'tree-elements-Graf-ActiveNode-TopNodeMenu-Required',
          },
        },
      },
      Hierarchy: {
